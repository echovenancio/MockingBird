...
urlpatterns = [
    ...
    path("register_to_course/<int:curso_id>", views.register_to_course, name="register-to-course"),
    path("start_module/<int:curso_id>/<int:module_id>", views.start_module, name="start-module"),
    path("finish_module/<int:curso_id>/<int:module_id>", views.finish_module, name="finish-module"),
